  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        var groupStyle = options.groupStyle;
        ...
        var groupCSS = typeof groupStyle === "function" ? groupStyle(action) : "";
        ...
        var message = "%caction " + formattedAction.type + formattedTime + formattedDuration;
        var startMessage = isCollapsed ? console.groupCollapsed : console.group;

        // render
        try {
          startMessage.call(console, message, groupCSS);
        } catch (e) {
          console.log(message);
        }
